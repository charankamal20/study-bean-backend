...
func main() {
	...
	router.GET("/", func(c *gin.Context) {
		html := fmt.Sprintf(htmlFormat, `Hello World new after change <a href="/auth/google">Login through Google</a> <a href="/auth/github">Login through Github</a> <a href="/auth/discord">Login through Discord</a>`)
